        ...
        <div className={'page'}>
            <div className={"form"}>
                ...
                <div className="form__login">
                    <span className="form__login-title form__login-title--disabled">Логин</span>
                    <input disabled value='login_hahaha' type='text' className="form__login-input form__login-input--disabled"></input>
                </div>
